"""
Django settings for GamesOfFuture project.
...
SECRET_KEY = '6da_5$(a(8e7-=3^f8e12t=9xvsc+dlvxg9e_+f0(f6+0ms!b^'
...
ROOT_URLCONF = 'GamesOfFuture.urls'
...
WSGI_APPLICATION = 'GamesOfFuture.wsgi.application'
